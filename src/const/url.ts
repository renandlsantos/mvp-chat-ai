...
export const DOCKER_IMAGE = 'https://hub.docker.com/r/agentssaas/agents-saas';
...
export const PLUGINS_INDEX_URL = 'https://chat-plugins.agentssaas.com';

export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/agentssaas/agents-saas/discussions/6157';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/agentssaas/agents-saas/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/agentssaas/agents-saas-agents';
