...
const errorMap = {
  [ErrorEnum.Configuration]:
    'Wrong configuration, make sure you have the correct environment variables set. Visit https://agentssaas.com/docs/self-hosting/advanced/authentication for more details.',
